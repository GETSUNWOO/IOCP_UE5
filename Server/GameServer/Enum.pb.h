...
enum ObjectType : int {
  ObjectType_TYPE_NONE = 0,
  ObjectType_TYPE_CREATURE = 1,
  ObjectType_TYPE_PROJECTILE = 2,
  ObjectType_TYPE_ENV = 3,
...
constexpr ObjectType ObjectType_MIN = ObjectType_TYPE_NONE;
constexpr ObjectType ObjectType_MAX = ObjectType_TYPE_ENV;
...
enum PlayerType : int {
  PLAYER_TYPE_NONE = 0,
  PLAYER_TYPE_ARCHER = 1,
  PLAYER_TYPE_GUNNER = 2,
  PLAYER_TYPE_MAGE = 3,
